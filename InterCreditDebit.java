...
public class InterCreditDebit {

    SendDebitCreditInter send = new SendDebitCreditInter();

    public void Credit_Debit_currency_InternationalTransactions(String base_curr, String Country_name, int cardcode, double amount, String name) throws SQLException, IOException {
        // North America
